...
<aside class="sidebar w-64 flex flex-col text-white">
    ...
    <nav class="flex-1 p-4 space-y-2">
        ...
        <a href="user_books.php" class="block px-3 py-2 rounded transition-colors">📚 Books</a>
    </nav>
</aside>
...
<div class="flex-1 flex flex-col">
    ...
    <header class="topbar flex items-center justify-between px-6 py-4">
        ...
        <div class="relative">
            ...
            <!-- Dropdown -->
            <div id="dropdownMenu" class="hidden absolute right-0 mt-2 w-40 bg-gray-800 border border-gray-700 rounded shadow-lg">
    ...
    <main class="flex-1 flex items-center justify-center p-6">
        <div class="card">
            ...
            <p>Glad to have you back! Explore your dashboard.</p>
        </div>
    </main>
</div>
